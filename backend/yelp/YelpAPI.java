...
public class YelpAPI {
	...
	// get your cliet id and secret from https://www.yelp.com/developers/v3/manage_app
	...
	public String searchForBusinessesByLocation(double lat, double lon) {
		...
		String query = String.format("term=%s&latitude=%s&longitude=%s&limit=%s&sort=%s",
				DEFAULT_TERM, latitude, longitude, SEARCH_LIMIT, 2);
		System.out.println("ATTENTION: "+query);
